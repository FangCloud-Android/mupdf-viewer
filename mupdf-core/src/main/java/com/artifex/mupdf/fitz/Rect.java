...
public class Rect
{
	...
	public android.graphics.RectF toGraphicsRectF() {
		return new android.graphics.RectF(x0, y0, x1, y1);
	}

	public android.graphics.Rect toGraphicsRect() {
		return new android.graphics.Rect((int)x0, (int)y0, (int)x1, (int)y1);
	}
}
